    ...
    function P() {
        ...
        for (let C = 0; C <= g.length - 1; C++) {
            ...
            if (O) {
                ...
                c.font = `${K}px Consolas`, c.fontVariantCaps="small-caps", c.fillStyle = "rgba(29,74,148,.8)", c.fillText(typeof O == "function" ? O(R, C) : typeof O == "boolean" ? R.id : O, R.x - w / 2, R.y + w / 2);
            }
        }
