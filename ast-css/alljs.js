...
function ToOld(b2past,b2futu,divpas,divfut){
    ...
    if((bf.style.display=="none")&&(bp.style.display=="none")){df.style.display="none";bf.style.display="none";dp.style.display="block";bp.style.display="none"}
    else{df.style.display="none";bf.style.display="none";dp.style.display="block";bp.style.display="block"}
}
function ToNew(b2past,b2futu,divpas,divfut){
    ...
    dp=document.getElementById(divpas);
    df=document.getElementById(divfut);
    if((bf.style.display=="none")&&(bp.style.display=="none")){dp.style.display="none";bp.style.display="none";df.style.display="block";bf.style.display="none"}
    else{dp.style.display="none";bp.style.display="none";df.style.display="block";bf.style.display="block"}
}
